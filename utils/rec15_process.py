...
PATH_TO_ORIGINAL_DATA = '/home/lyt/workspace/recsys/data/rec15/'
PATH_TO_PROCESSED_DATA = '/home/lyt/workspace/recsys/data/rec15/'

data = pd.read_csv(PATH_TO_ORIGINAL_DATA + 'yoochoose-clicks.dat', \
